...
def vendored_vector() -> VendoredVector:
    # The issuer key, namespace, doctype, attribute value, and device-namespaces bytes are
    # not in the JSON. They are the values the crate's own mdoc_zk interop tests pass for
    # this vector.
